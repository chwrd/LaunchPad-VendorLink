  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f7f9fa]">
      <div className="bg-white rounded-xl shadow-lg p-10 w-[400px] flex flex-col items-center">
        <h2 className="text-2xl font-bold mb-2 text-[#179b98]">Support Ticket</h2>
        ...
        <form className="w-full flex flex-col gap-4">
          ...
          <button type="submit" className="rounded-full bg-[#179b98] text-white py-2 mt-2 shadow-md hover:bg-[#117c7a] transition-all text-lg font-normal">Submit Ticket</button>
        </form>
      </div>
    </div>
  );
